...
data = [
    ...
    [28, 1, 1, 15],  # Agak panas, kuliah, baru minum => minum sebentar lagi
    [21, 0, 0, 30],  # Dingin, rebahan, belum minum => minum sebentar lagi
    [29, 2, 0, 120], # Panas, olahraga, belum minum lama => minum
    [24, 0, 1, 5],   # Normal, rebahan, baru minum => cukup
    [26, 1, 1, 35],  # Sedikit lama => minum sebentar lagi
]
